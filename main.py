# python main.py --mode train --cfg yolov3-tiny_tstl_416.cfg --gpus 0 --checkpoint ./output/model_epoch50.pth
# python main.py --mode train --cfg yolov3-tiny_tstl_352.cfg --gpus 0 --checkpoint ./output/model_epoch50.pth
# python main.py --mode demo --cfg yolov3-tiny_tstl_416.cfg --gpus 0 --checkpoint ./output/model_epoch50.pth
# python main.py --mode demo --cfg yolov3-tiny_tstl_352.cfg --gpus 0 --checkpoint ./output/model_epoch20.pth
